#include "PluginLoadException.h"

Moonlit::Debug::Exceptions::PluginLoadException::PluginLoadException(Moonlit::Debug::Exceptions::PluginLoadError _error, std::string _pluginName, HMODULE _pluginModule)
