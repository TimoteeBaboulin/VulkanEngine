...
Moonlit::Debug::Profiler& Moonlit::Debug::Profiler::Get()
{
	static Profiler instance;
	return instance;
}

Moonlit::Debug::Profiler::Profiler()
{
...
void Moonlit::Debug::Profiler::StartProfiling()
{
	std::lock_guard<std::mutex> lock(m_runningMutex);
	if (!m_running)
	{
...
void Moonlit::Debug::Profiler::StopProfiling()
{
	if (m_running)
	{
		m_runningMutex.lock();
...
void Moonlit::Debug::Profiler::SetProfileInterval(double _intervalMs)
{
	if (_intervalMs <= 0)
	{
...
Moonlit::Debug::FrameSample Moonlit::Debug::Profiler::GetLastFrameSample()
{
	std::lock_guard<std::mutex> lock(m_runningMutex);
...
Moonlit::Debug::ProfilingSession Moonlit::Debug::Profiler::GetCurrentSession()
{
	std::lock_guard<std::mutex> lock(m_runningMutex);
	return m_currentSession;
}

uint64_t Moonlit::Debug::Profiler::GetCurrentFrameId()
{
	std::lock_guard<std::mutex> lock(m_runningMutex);
	return m_currentFrameId;
}

void Moonlit::Debug::Profiler::BuildStackFrame(LPSTACKFRAME _frame, LPDWORD _imageType, CONTEXT& _ctx)
{
#ifdef _M_IX86
...
std::vector<Moonlit::Debug::ThreadAddressSample> Moonlit::Debug::Profiler::GetStackAddresses()
{
...
Moonlit::Debug::FrameSample Moonlit::Debug::Profiler::ProfileFrame()
{
	Moonlit::Debug::FrameSample sample;
...
void Moonlit::Debug::Profiler::Profile()
{
