...
Moonlit::Inputs::InputManager* Moonlit::Inputs::InputManager::m_instance;

//InputInstance readers to dispatch to the right method

void Moonlit::Inputs::InputManager::ReadInput(InputInstance _instance)
{
...
void Moonlit::Inputs::InputManager::ReadMouseInput(InputInstance _instance)
{
...
void Moonlit::Inputs::InputManager::ReadKeyboardInput(InputInstance _instance)
{
...
void Moonlit::Inputs::InputManager::ReadGamepadInput(InputInstance _instance)
{
	if (_instance.InputType == InputInstance::INPUT_STATE::AXIS)
	{
		float* rawInput = static_cast<float*>(_instance.RawInput);
...
void Moonlit::Inputs::InputManager::HandleMouseMovement(float _x, float _y, void* _winHandle)
{
...
void Moonlit::Inputs::InputManager::HandleMouseInput(MOUSE_KEY _key, bool _keyDown, void* _winHandle)
{
	std::vector<InputHandler*> inputHandlers = GetInputHandlersForWindow(_winHandle);
...
void Moonlit::Inputs::InputManager::HandleKeyboardInput(KEYBOARD_KEY _key, bool _keyDown, void* _winHandle)
{
	std::vector<InputHandler*> inputHandlers = GetInputHandlersForWindow(_winHandle);
...
void Moonlit::Inputs::InputManager::HandleGamepadInput(GAMEPAD_KEY _key, bool _keyDown, void* _winHandle)
{
	std::vector<InputHandler*> inputHandlers = GetInputHandlersForWindow(_winHandle);
...
void Moonlit::Inputs::InputManager::HandleGamepadAxis(GAMEPAD_KEY _key, float _x, float _y, void* _winHandle)
{
	std::vector<InputHandler*> inputHandlers = GetInputHandlersForWindow(_winHandle);
...
std::vector<Moonlit::Inputs::InputHandler*> Moonlit::Inputs::InputManager::GetInputHandlersForWindow(void* _winHandle)
{
...
Moonlit::Inputs::InputManager::InputManager(void* _handle)
{
#ifdef _WIN32
...
void Moonlit::Inputs::InputManager::InitManager(void* _handle)
{
	if (m_instance == nullptr)
	{
		...
		catch (std::exception e)
		{
			...
			errorMsg += e.what();
			Moonlit::Debug::Logger::LogWarning(errorMsg.data());
			m_instance = nullptr;
		}
	}
}

void Moonlit::Inputs::InputManager::SubscribeKeyboardEvent(KEY_STATE _state, KeyboardInputCallback _callback)
{
	m_keyboardInputCallbacks[(int)_state].push_back(_callback);
}

void Moonlit::Inputs::InputManager::SubscribeGamepadEvent(KEY_STATE _state, GamepadInputCallback _callback)
{
	m_gamepadInputCallbacks[(int)_state].push_back(_callback);

}

void Moonlit::Inputs::InputManager::SubscribeGamepadAxisEvent(GamepadAxisInputCallback _callback)
{
	m_gamepadAxisInputCallbacks.push_back(_callback);
}

void Moonlit::Inputs::InputManager::SubscribeMouseEvent(KEY_STATE _state, MouseInputCallback _callback)
{
	m_mouseInputCallbacks[(int)_state].push_back(_callback);

}

void Moonlit::Inputs::InputManager::SubscribeWindowEvent(WindowEventCallback _callback)
{
	m_windowEventCallbacks.push_back(_callback);
}

void Moonlit::Inputs::InputManager::LinkQtApplication(QApplication* _qApp)
{
	m_platformInput->LinkQtApplication(_qApp);
}

void Moonlit::Inputs::InputManager::PollEvents()
{
...
void Moonlit::Inputs::InputManager::WindowResize(int _width, int _height)
{
	int* Size = new int[2];
	Size[0] = _width;
	Size[1] = _height;
...
void Moonlit::Inputs::InputManager::WindowClose()
{
	for (auto& callback : m_windowEventCallbacks)
	{
...
void Moonlit::Inputs::InputManager::AddInputHandler(InputHandler* _handler)
{
...
void Moonlit::Inputs::InputManager::RemoveInputHandler(InputHandler* _handler)
{
	const auto& it = std::find(m_inputHandlers.begin(), m_inputHandlers.end(), _handler);
	if (it == m_inputHandlers.end())
	{
...
void Moonlit::Inputs::InputManager::LockCursor()
{
	m_platformInput->LockCursor();
}

void Moonlit::Inputs::InputManager::UnlockCursor()
{
