...
Moonlit::Inputs::WindowsInputAbstraction* Moonlit::Inputs::WindowsInputAbstraction::m_instance = nullptr;

// Maps between windows' API enums and platform agnostic ones

std::map<int, Moonlit::Inputs::KEYBOARD_KEY> Moonlit::Inputs::WindowsInputAbstraction::m_keyMap =
{
...
std::map<int, Moonlit::Inputs::GAMEPAD_KEY> Moonlit::Inputs::WindowsInputAbstraction::m_gamepadKeyMap =
{
...
void Moonlit::Inputs::WindowsInputAbstraction::OnKeyboardInput(WPARAM _wParam, bool _keyDown, void* _winHandle)
{
...
void Moonlit::Inputs::WindowsInputAbstraction::OnMouseMove(POINT _point, void* _winHandle)
{
	int deltaX = 0;
	int deltaY = 0;
...
void Moonlit::Inputs::WindowsInputAbstraction::OnMouseClick(MOUSE_KEY _key, bool _keyDown, void* _winHandle)
{
	InputInstance instance;
	instance.DeviceType = InputInstance::INPUT_DEVICE_TYPE::MOUSE;
	instance.InputType = _keyDown ? InputInstance::INPUT_STATE::STARTED : InputInstance::INPUT_STATE::CANCELLED;
...
void Moonlit::Inputs::WindowsInputAbstraction::OnGamepadInput(GAMEPAD_KEY _key, bool _keyDown, void* _winHandle)
{
	InputInstance instance;
...
void Moonlit::Inputs::WindowsInputAbstraction::OnGamepadAxis(GAMEPAD_KEY _key, float _x, float _y, void* _winHandle)
{
	InputInstance instance;
	instance.DeviceType = InputInstance::INPUT_DEVICE_TYPE::GAMEPAD;
	instance.InputType = InputInstance::INPUT_STATE::AXIS;
...
Moonlit::Inputs::WindowsInputAbstraction::WindowsInputAbstraction(HWND _windowHandle) : m_windowHandle(_windowHandle)
{
	...
	m_eventReader = new Moonlit::Inputs::QtEventReader(_windowHandle, this);
}

void Moonlit::Inputs::WindowsInputAbstraction::HandleWindowsEvents(void* _handle, MSG _msg)
{
	wchar_t buffer[32];
...
void Moonlit::Inputs::WindowsInputAbstraction::Init()
{
	//SetWindowLongPtrA(m_windowHandle, GWLP_WNDPROC, (LONG_PTR)WndProcCallback);
}

void Moonlit::Inputs::WindowsInputAbstraction::PollEvents()
{
...
void Moonlit::Inputs::WindowsInputAbstraction::LockCursor()
{
...
void Moonlit::Inputs::WindowsInputAbstraction::UnlockCursor()
{
	ClipCursor(nullptr);
