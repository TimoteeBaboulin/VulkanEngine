...
#include "Engine/Renderer/Helpers/VertexInputHelper.h"

Moonlit::MaterialInstance::MaterialInstance(vk::Device _device, Material* _material, vk::Format _colorOutputFormat)
{
...
Moonlit::MaterialInstance::~MaterialInstance()
{
...
void Moonlit::MaterialInstance::CreateUboDescriptorSetLayout()
{
...
void Moonlit::MaterialInstance::CreateTextureDescriptorSetLayout()
{
...
void Moonlit::MaterialInstance::CreatePipelineLayouts()
{
...
void Moonlit::MaterialInstance::CreatePipelines()
{
...
#pragma region Vertex
	...
	Moonlit::Renderer::HelperClasses::VertexInputBuilder  vertexInputBuilder;
...
#pragma region SubpassDependancy
	...
	for (auto& subpassName : subpassNames)
	{
		...
		for (auto& entryPoint : m_shaderData.EntryPoints)
		{
			...
			shaderModules.emplace_back(Moonlit::Renderer::HelperClasses::vhf::WrapShader(m_device, entryPoint.Function.Code.CodePtr, entryPoint.Function.Code.Size));
...
void Moonlit::MaterialInstance::CreateDescriptorPool()
{
...
void Moonlit::MaterialInstance::BindPipeline(vk::CommandBuffer _buffer, std::string _renderPass)
{
