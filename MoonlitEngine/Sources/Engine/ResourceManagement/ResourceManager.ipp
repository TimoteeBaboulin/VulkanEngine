#ifndef MOONLIT_RESOURCEMANAGER_IPP
#define MOONLIT_RESOURCEMANAGER_IPP
...
namespace Moonlit::ResourceManagement
{
    ...
    template<class RESOURCE_TYPE>
    bool ResourceManager::TryLoadResourceInstance(std::string _path) {
...
#endif //MOONLIT_RESOURCEMANAGER_IPP